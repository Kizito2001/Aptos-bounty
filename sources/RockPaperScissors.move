address 0xce6af6e812be5728d1c8a4bea471820ce291dd4f1d78493f535deb774a2838fb {
...
module RockPaperScissors {
    ...
    public entry fun finalize_game(account: &signer) acquires Game {
        let game = borrow_global_mut<Game>(signer::address_of(account));
    ...
    #[view]
    public fun get_player_score(account_addr: address): u32 acquires Game {
        borrow_global<Game>(account_addr).player_score
    }

    #[view]
    public fun get_computer_score(account_addr: address): u32 acquires Game {
